...
public class MyConsumtiFragment1 extends BaseFragment implements OnRefreshListener2<ListView>{
...
//		initTopBar("我的消费");
	...
	public void loadData() {
		...
		new HttpUtils().send(HttpMethod.POST, Api.MYCONSUMPTIONNEW, params, new RequestCallBack<String>() {
			@Override
