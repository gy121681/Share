...
//			tv_shopFilialPric.setText(Util.getnum(bean.data.shopFilialPric,false));
			...
			if(bean.data.userFilialPricRate!=null){
				tv_userFilialPric.setText(String.format("%s", Util.getfotmatnum(bean.data.userFilialPricRate, true,1)));
			}
			if(bean.data.shopFilialPricRate!=null){
				tv_shopFilialPric.setText(String.format("%s", Util.getfotmatnum(bean.data.shopFilialPricRate, true,1)));
			}
