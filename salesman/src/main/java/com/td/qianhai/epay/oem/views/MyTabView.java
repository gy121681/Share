...
////			 } 
//			
//			((ViewPager) arg0).addView(mFragments.get(arg1).getView(), 0);
//			return mFragments.get(arg1);
//		}
//		
//		
////		@Override
...
////			// TODO Auto-generated method stub
////	 		((Fragment) container).addView(mFragments.get(position), 0);
////			return mFragments.get(position);
////			
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
	 ...
	 class MyFrageStatePagerAdapter extends FragmentStatePagerAdapter  
	    {  
			...
			public MyFrageStatePagerAdapter(FragmentManager fm, List<Fragment> mFragments)
			{
				super(fm);
				this.mFragments=mFragments;
			}
	        ...
	        {  
	            ...
	            int currentItem=mytab_pager.getCurrentItem();  
	            if (currentItem==currenttab)  
	            {  
	                return ;  
	            }  
//	            imageMove(mytab_pager.getCurrentItem());  
	            currenttab=mytab_pager.getCurrentItem();  
	        }  
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		@SuppressLint("NewApi") private void scroll() {
