 ...
 */
public class AnimatorInflaterem {
    ...
    /**
     * Loads an {@link Animatorem} object from a resource
     *
     ...
     */
    public static Animatorem loadAnimator(Context context, int id)
    ...
    private static Animatorem createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static Animatorem createAnimatorFromXml(Context c, XmlPullParser parser,
        ...
        Animatorem anim = null;
        ArrayList<Animatorem> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<Animatorem>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            Animatorem[] animsArray = new Animatorem[childAnims.size()];
            int index = 0;
            for (Animatorem a : childAnims) {
                animsArray[index++] = a;
            }
