...
public class RecordedSinhleMainFragment extends BaseFragment implements   OnClickListener{

	private ViewPager mPaper;
	private FragmentPagerAdapter mAdapter;
	private RadioButton btn_1,btn_2;
	private List<Fragment> mFragments = new ArrayList<Fragment>();
	private RecordedSingleFragment1 fm1;
	private RecordedSingleFragment2 fm2 ;
...
//	FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
	private void initlayout() {
        ...
        if(fm1==null){
        	fm1 = new RecordedSingleFragment1();
        }
...
//        	ft.add(0, fm1);
        ...
        if(fm2==null){
        	 fm2 = new RecordedSingleFragment2();
        }
...
//		mFragments.add(fm2);
    ...
    public void onStart() {
        super.onStart();
        mPaper.setCurrentItem(1);
        getView(R.id.img_logo).setVisibility(View.GONE);
    }
