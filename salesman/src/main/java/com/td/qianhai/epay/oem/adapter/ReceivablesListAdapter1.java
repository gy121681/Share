 ...
 * 
 */
public class ReceivablesListAdapter1 extends BaseAdapter {

	private Context context;
	private ArrayList<HashMap<String, Object>> list;
	private String subMchId;

	public ReceivablesListAdapter1(Context context,
...
//            	  tv_money.setText(getWeek(aa+"00000000"));
		...
		if(maps.get("dayTotalCount")!=null){
			holder.tv_name.setText("共"+maps.get("dayTotalCount").toString()+"笔");
		}
	
		
		if(maps.get("dayTotalFee")!=null){
			
			String a = String .format("%.2f",Double.parseDouble(maps.get("dayTotalFee").toString())/100);
