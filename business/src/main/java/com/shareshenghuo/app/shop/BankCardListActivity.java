...
import com.shareshenghuo.app.shop.adapter.BankcardSlideAdapter;
import com.shareshenghuo.app.shop.manager.UserInfoManager;
import com.shareshenghuo.app.shop.network.bean.MyBankCardBean;
import com.shareshenghuo.app.shop.network.response.BankCardResponse;
...
//				refreshscrollview.onRefreshComplete();
                BankCardResponse bean = new Gson().fromJson(resp.result, BankCardResponse.class);
