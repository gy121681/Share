...
public class JSONObject {
	...
	public static final Object NULL = new Object() {
		...
		public boolean equals(Object o) {
			return o == this || o == null; // APITool specifies this broken equals
											// implementation
		}
	 ...
	 */
	/* (accept a raw type for APITool compatibility) */
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a long or
	 * can be coerced to a long. Returns 0 otherwise. Note that JSON represents
	...
	/**
	 * Returns the value mapped by {@code name} if it exists and is a long or
	 * can be coerced to a long. Returns {@code fallback} otherwise. Note that
	 * JSON represents numbers as doubles, so this is <a
	 ...
	 */
	/* Return a raw type for APITool compatibility */
