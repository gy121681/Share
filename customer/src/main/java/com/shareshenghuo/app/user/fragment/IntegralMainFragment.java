...
import com.shareshenghuo.app.user.IntegralFragment;
import com.shareshenghuo.app.user.IntegralFragment1;
import com.shareshenghuo.app.user.R;

public class IntegralMainFragment extends BaseFragment implements   OnClickListener{

	private ViewPager mPaper;
	private FragmentPagerAdapter mAdapter;
	private RadioButton btn_1,btn_2;
	private List<Fragment> mFragments = new ArrayList<Fragment>();
	private IntegralFragment fm1;
	private IntegralFragment1 fm2 ;
	...
	protected void init(View rootView) {
		...
		//initTopBar("秀儿积分", "公益积分");
		initTopBar("产业链积分", "秀儿积分");
