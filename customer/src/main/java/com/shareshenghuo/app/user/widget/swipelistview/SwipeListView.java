package com.shareshenghuo.app.user.widget.swipelistview;
...
import com.shareshenghuo.app.user.widget.swipelistview.SwipeListViewListener;
import com.shareshenghuo.app.user.widget.swipelistview.SwipeListViewTouchListener;
...
public class SwipeListView extends ListView {
    ...
    */
    ...
    protected void onStartOpen(int position, int action, boolean right) {
        if (swipeListViewListener != null && position != AdapterView.INVALID_POSITION) {
