...
import com.shareshenghuo.app.user.fragment.ShuntFragment2;
import com.shareshenghuo.app.user.networkapi.Api;

public class ShuntMainFragment extends BaseFragment implements OnClickListener {

	private ViewPager mPaper;
	private FragmentPagerAdapter mAdapter;
	private RadioButton btn_1, btn_2;
	private List<Fragment> mFragments = new ArrayList<Fragment>();
	private ShuntFragment1 fm1;
	private ShuntFragment2 fm2;
	...
	protected void init(View rootView) {
		...
		btnTopRight1.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent about = new Intent(getActivity(), WebLoadActivity.class);
				about.putExtra("title", "说明");
