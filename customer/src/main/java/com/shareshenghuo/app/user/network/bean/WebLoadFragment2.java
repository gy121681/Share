 ...
 * 加载网页
 */
public class WebLoadFragment2 extends Fragment {
...
//			getInstance("", "http://119.23.146.39/mobile/?u=92", true);
			getInstance("", "", true);
	}
    public static synchronized WebLoadFragment2 getInstance(String url) {
        return getInstance("", url, true);
    }

    public static synchronized WebLoadFragment2 getInstance(String title, String url, boolean back) {
        WebLoadFragment2 mInstance = new WebLoadFragment2();
