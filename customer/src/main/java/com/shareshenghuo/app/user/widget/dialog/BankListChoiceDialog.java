...
public class BankListChoiceDialog extends Dialog {
	...
	public static class Builder {
		...
		private List<MyBankCardBean> bean;
		...
		public List<MyBankCardBean> getCheckedItems() {
			if(listView != null){
		 ...
		 * @return
		 */
		public Builder setMultiChoiceItems(List<MyBankCardBean> bean,
		...
		class OnMultiItemClick implements OnItemClickListener {
			...
			public void onItemClick(AdapterView<?> parent, View view, int positon, long arg3) {
				...
				List<MyBankCardBean> aa = ((CheckAdapter)listView.getAdapter()).getCheckedItem();
		...
		public class CheckAdapter extends BaseAdapter {
			...
			private List<MyBankCardBean> areas;


			public CheckAdapter(Context context,List<MyBankCardBean> areas,String tag) {
				this.areas = areas;
				this.tag =tag;
			...
			public List<MyBankCardBean> getCheckedItem() {
