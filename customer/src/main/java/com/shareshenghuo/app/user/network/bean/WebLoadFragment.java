...
//    private ValueCallback<Uri> mUploadMessage;
	...
	private OnTLPaySuccessListener mPaySuccessListener;
    ...
    /** 通联支付成功回调 */
    public interface  OnTLPaySuccessListener{
        void onpaySuccess();
    }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			if(url.contains("baidu.com")){
				...
				if(mPaySuccessListener != null){
                    mPaySuccessListener.onpaySuccess();
                }
				return false;
			}
...
//					Uri result = intent == null || resultCode != RESULT_OK ? null : intent.getData();
    ...
    public void setmPaySuccessListener(OnTLPaySuccessListener mPaySuccessListener) {
        this.mPaySuccessListener = mPaySuccessListener;
    }
}
