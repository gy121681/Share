...
public class Constant extends EaseConstant{
	...
	public static String[] ORDER_STATUS = {"交易取消", "待付款", "支付成功，待确认", "派送中", "商家已确认", "已上菜",
			"交易成功", "已评价", "申请退款中", "退款成功", "退款拒绝", "商家拒绝",
			"派送中,待商家确认", "已上菜,待商家确认", "", "等待商家上菜中"};
	
	public static int[] ORDER_STATUS_ICON = {R.drawable.status_0, 
											R.drawable.status_1,
											R.drawable.status_2,
											R.drawable.status_3,
											R.drawable.status_4,
