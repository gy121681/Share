...
public class RehistoryListMainFragment extends BaseFragment implements   OnClickListener{

	private ViewPager mPaper;
	private FragmentPagerAdapter mAdapter;
	private RadioButton btn_1,btn_2;
	private List<Fragment> mFragments = new ArrayList<Fragment>();
	private RehistoryListFragment1 fm1;
	private RehistoryListFragment2 fm2 ;
...
//	FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
	private void initlayout() {
        ...
        if(fm1==null){
        	fm1 = new RehistoryListFragment1();
        }
...
//        	ft.add(0, fm1);
        ...
        if(fm2==null){
        	 fm2 = new RehistoryListFragment2();
        }
