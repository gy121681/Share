...
public class MyTabView extends LinearLayout {
	...
	private int slideColor = R.color.text_orange;
...
//		ll.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.WRAP_CONTENT, 1f));
		ll.setLayoutParams(new LinearLayout.LayoutParams(sliderWidth, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
