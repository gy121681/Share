...
public class ShuntFragment2 extends BaseFragment implements OnClickListener {
					...
					public void onSuccess(ResponseInfo<String> resp) {
						...
						if (Api.SUCCEED == bean.result_code) {
							tv_num.setText(Util.getnum(
									bean.data.totalFilialMoney, false) + "");
							num1.setText(Util.getnum(bean.data.filialMoney,
									false) + "");
							num2.setText(Util.getnum(bean.data.stayFilialMoney,
									false) + "");
							num = bean.data.stayFilialMoney;
	...
	private void initview() {
		...
		// ViewUtil.showtip(getActivity(), getView(R.id.ll), 0,
		// statusBarHeight1, "mfirst4", R.drawable.xiaofenpro,null);
		// }
	...
	public void onClick(View v) {
		...
		case R.id.btn1:
			...
			Intent it = new Intent(getActivity(), IncentivePointsActivity.class);// 可兑换秀点
	...
	private void showMask(final int statusBarHeight1, final int tip,
			final String string, final View view) {
