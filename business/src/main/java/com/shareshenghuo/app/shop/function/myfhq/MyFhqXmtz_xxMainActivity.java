...
public class MyFhqXmtz_xxMainActivity extends BaseTopActivity implements
	...
	private void initnum() {
		...
		req.userId = UserInfoManager.getUserInfo(MyFhqXmtz_xxMainActivity.this).shop_id
				+ "";
		req.userType = "2";
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> resp) {
						...
						if (Api.SUCCEED == bean.result_code) {
							...
							// + " ");
							// cyl_xxnum
							// =Util.getfotmatnum(bean.data.shareFilialPietyNew,
							// true, 1);
							// gy_xxnum
							// =Util.getfotmatnum(bean.data.shareFilialPiety,
							// true, 1);
	...
	void toxxMainActivity() {// 跳到主界面
		...
		i.setClass(MyFhqXmtz_xxMainActivity.this, MyFhqMainActivity.class);
