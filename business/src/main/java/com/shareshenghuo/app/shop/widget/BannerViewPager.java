...
public class BannerViewPager<T extends Banner> extends RelativeLayout {
	...
	public void setLayoutWidthHeight(double ratio) {
		setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, (int) Arith.mul(BitmapTool.getScreenWidthPX(mContext), ratio)));
	}
...
//				String url = null;
//				if(TextUtils.isEmpty(banner.active_url))
//					url = Api.URL_BANNER_DETAIL+"?active_id="+banner.id;
//				else
//					url = banner.active_url;
