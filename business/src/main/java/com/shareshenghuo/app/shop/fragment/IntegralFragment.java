...
public class IntegralFragment extends BaseFragment implements OnRefreshListener2<ListView>{
			...
			public void onSuccess(ResponseInfo<String> resp) {
				...
				if(Api.SUCCEED == bean.result_code) {
					if(bean.data.integralNew!=null){
						tv_num.setText(Util.getnum(bean.data.integralNew+"", false));
						tv_num1.setText(Util.getnum(bean.data.totalIntegralNew+"", false));
					}
...
//		updateView(bean);
		...
		new HttpUtils().send(HttpMethod.POST, Api.INTEGRALLISTNEW, params, new RequestCallBack<String>() {
			@Override
			public void onFailure(HttpException arg0, String arg1) {
