...
package com.shareshenghuo.app.user.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.shareshenghuo.app.user.R;
import com.shareshenghuo.app.user.wheelview.ItemsRange;
import com.shareshenghuo.app.user.wheelview.WheelRecycle;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.applin));
		// 设置线宽
