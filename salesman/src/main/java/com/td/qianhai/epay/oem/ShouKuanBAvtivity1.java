...
@SuppressLint("JavascriptInterface") public class ShouKuanBAvtivity1 extends BaseActivity {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				warnDialog = new OneButtonDialogWarn(
						ShouKuanBAvtivity1.this, R.style.CustomDialog,
						"提示", result.get(Entity.RSPMSG).toString(),
						"确定", new OnMyDialogClickListener() {
							@Override
							public void onClick(View v) {
								Intent it = new Intent(ShouKuanBAvtivity1.this,AuthenticationActivity1.class);
								startActivity(it);
								finish();
								warnDialog.dismiss();
							}
			...
			case 2:
				...
				warnDialog = new OneButtonDialogWarn(
						...
						"确定", new OnMyDialogClickListener() {
							@Override
							public void onClick(View v) {
								Intent it = new Intent(ShouKuanBAvtivity1.this,NewRealNameAuthenticationActivity.class);
