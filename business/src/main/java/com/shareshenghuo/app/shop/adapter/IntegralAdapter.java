...
public class IntegralAdapter extends CommonAdapter<IntegralBean>{
	...
	public void conver(ViewHolder holder, final IntegralBean item, int position) {
		...
		if(item.operb_type.equals("0")){
			...
			holder.setText(R.id.tv_toamounts, "+"+Util.getfotmatnum(item.integral_num, true,1));
			if(item.total_fee!=null){
				if(item.opers_type.equals("02")){
					...
					holder.setText(R.id.tv_amount,"油卡消费 ￥: "+Util.getfotmatnum(item.total_fee, true,1));
					...
					holder.setText(R.id.tv_amount, "交易金额: "+Util.getfotmatnum(item.total_fee, true,1));
...
//				if(holder.getView(R.id.rate_img).getTag().equals("1")){
					holder.setImageResource(R.id.rate_img, R.drawable.consume_series_25);
//				}else{
...
//				if(holder.getView(R.id.rate_img).getTag().equals("2")){
					holder.setImageResource(R.id.rate_img, R.drawable.consume_series_50);
//				}else{
//					holder.setImageResource(R.id.rate_img, R.drawable.point_2);
//				}
...
//				if(holder.getView(R.id.rate_img).getTag().equals("3")){
					holder.setImageResource(R.id.rate_img, R.drawable.consume_series_100);
//				}else{
//					holder.setImageResource(R.id.rate_img, R.drawable.point_2);
//				}
			}else{
			 ...
			 if(item.opers_type.equals("13")){
				 holder.setImageResource(R.id.xiaofen, R.drawable.share_b_mine_icon1_xiuxin);
...
//			holder.setImageResource(R.id.rate_img, R.drawable.point_2);
//			holder.setImageResource(R.id.xiaofen, R.drawable.share_b_mine_icon1_xiudian);
			 if(item.opers_type.equals("13")){
				 holder.setImageResource(R.id.xiaofen, R.drawable.share_b_mine_icon1_xiuxin);
				holder.getView(R.id.rate_img).setVisibility(View.GONE);
				holder.getView(R.id.oiltypes).setVisibility(View.GONE);
				...
				if(item.money_num!=null){
					holder.getView(R.id.oiltypes).setVisibility(View.GONE);
					holder.setText(R.id.oiltypes,"");
					holder.setText(R.id.tv_amount, "激励到账: "+Util.getfotmatnum(item.money_num, true,1));
