...
import com.shareshenghuo.app.user.adapter.IncentivePointsAdapter;
 ...
 * @author hang 收藏的商家
 */
public class IncentivePointsGYL1Fragment extends BaseFragment implements
	...
	public void loadData() {
		...
		new HttpUtils().send(HttpMethod.POST, Api.OBEDIENCELISTNEW, params,
	...
	// requestCode==OrderListAdapter.REQ_ORDER_OPERATE)
