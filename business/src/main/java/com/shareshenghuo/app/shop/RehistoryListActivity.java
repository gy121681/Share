...
public class RehistoryListActivity extends BaseTopActivity implements OnClickListener,OnRefreshListener2<ListView>{
...
//	private List<String> list1 = new ArrayList<String>();
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(R.layout.rehistory_list_activity);
	...
	private void initview() {
		// TODO Auto-generated method stub
		initTopBar("历史订单");
		getView(R.id.lllayout1).setOnClickListener(this);
		getView(R.id.lllayout2).setOnClickListener(this);
	...
	public void getStatisticsData() {
		...
		new HttpUtils().send(HttpMethod.POST, Api.GETSHOPORDERDETAILS, params, new RequestCallBack<String>() {
			...
			public void onFailure(HttpException arg0, String arg1) {
				T.showNetworkError(RehistoryListActivity.this);
			}
...
//					Utility.setListViewHeightBasedOnChildren(lvMsg);
	...
	public void updateView(List<RehistoryBean> data) {
		if(pageNo==1 || adapter==null) {
			adapter = new RehistoryListActivityAdapter(RehistoryListActivity.this, data);
	...
	public void onClick(View v) {
		...
		case R.id.lllayout1:
			if(pay_status_list!=null){
				showPopupWindow(getView(R.id.lllayout1), pay_status_list,0);
			}
			
			break;
		case R.id.lllayout2:
			if(discount_rate_list!=null){
				showPopupWindow(getView(R.id.lllayout2), discount_rate_list,1);
			}
			break;
		case R.id.lllayout3:
			setdate();
...
//					loadData();
	 ...
	 private void showPopupWindow(View view,List<PaystatusListBean> listbean,final int tag) {
	        ...
	        // 一个自定义的布局，作为显示的内容
	        View contentView = LayoutInflater.from(RehistoryListActivity.this).inflate(
	        ...
	        final PopupWindow popupWindow = new PopupWindow(contentView,
	        		getView(R.id.lllayout1).getWidth(), LayoutParams.WRAP_CONTENT, true);
