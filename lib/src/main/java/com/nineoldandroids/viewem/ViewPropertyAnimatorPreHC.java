...
package com.nineoldandroids.viewem;
...
import com.nineoldandroids.animationem.ValueAnimator;
import com.nineoldandroids.view.animationem.AnimatorProxy;
...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
     ...
     */
    private Animatorem.AnimatorListener mListener = null;
     ...
     */
    private HashMap<Animatorem, PropertyBundle> mAnimatorMap =
            new HashMap<Animatorem, PropertyBundle>();
    ...
    @Override
    public ViewPropertyAnimator setListener(Animatorem.AnimatorListener listener) {
        mListener = listener;
        return this;
    }
    ...
    public void cancel() {
        if (mAnimatorMap.size() > 0) {
            HashMap<Animatorem, PropertyBundle> mAnimatorMapCopy =
                    (HashMap<Animatorem, PropertyBundle>)mAnimatorMap.clone();
            Set<Animatorem> animatorSet = mAnimatorMapCopy.keySet();
            for (Animatorem runningAnim : animatorSet) {
                runningAnim.cancel();
            }
        }
    ...
    private void animatePropertyBy(int constantName, float startValue, float byValue) {
        ...
        if (mAnimatorMap.size() > 0) {
            Animatorem animatorToCancel = null;
            Set<Animatorem> animatorSet = mAnimatorMap.keySet();
            for (Animatorem runningAnim : animatorSet) {
    ...
    private class AnimatorEventListener
            implements Animatorem.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        @Override
