...
import com.shareshenghuo.app.user.adapter.IncentivePoints1Adapter;
...
import com.shareshenghuo.app.user.network.response.FilialobeResponse;
 ...
 * 收藏的商家
 */
public class IncentivePointsGYLFragment extends BaseFragment implements OnRefreshListener2<ListView> {
...
private PullToRefreshListView lvData;
	...
	public void loadData() {
		...
		new HttpUtils().send(HttpMethod.POST, Api.OBEDIENCELISTNEW, params, new RequestCallBack<String>() {
			@Override
