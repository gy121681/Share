...
public class ChooseCardTypeActivity extends BaseTopActivity {
	...
	private void initview() {
		...
		card_1.setTextColor(getResources().getColor(R.color.text_orange));
		card_2 = (RadioButton) findViewById(R.id.card_2);
		card_1.setTextColor(getResources().getColor(R.color.text_gray));
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.card_1:
				type = "1";
				card_1.setTextColor(getResources().getColor(R.color.text_orange));
				card_2.setTextColor(getResources().getColor(R.color.text_gray));
			...
			case R.id.card_2:
				type = "2";
				card_1.setTextColor(getResources().getColor(R.color.text_gray));
				card_2.setTextColor(getResources().getColor(R.color.text_orange));
				if(banklist2.size()>0){
					banklist.clear();
