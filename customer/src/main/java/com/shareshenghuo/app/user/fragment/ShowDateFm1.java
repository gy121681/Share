...
public class ShowDateFm1 extends BaseFragment{
...
//						lvData.setAdapter(new DataReportAdapter(activity, bean.data));
		...
		public void loadData(String initstartdates) {
			...
			new HttpUtils().send(HttpMethod.POST, Api.CONSUMPTIONLISTNEW, params, new RequestCallBack<String>() {
				@Override
				public void onFailure(HttpException arg0, String arg1) {
...
//			}
			tv_num.setText("全产业链消费总额"+Util.getnum(data.total_consumption,true));
			List<ExcitationBean> bean = new ArrayList<ExcitationBean>();
