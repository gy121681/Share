	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.imageView = (ImageView) convertView
					.findViewById(R.id.image_view);//(Res.getWidgetID("image_view"));
			viewHolder.toggleButton = (ToggleButton) convertView
					.findViewById(R.id.toggle_button);//(Res.getWidgetID("toggle_button"));
			viewHolder.choosetoggle = (Button) convertView
					.findViewById(R.id.choosedbt);//(Res.getWidgetID("choosedbt"));
			viewHolder.toggle = (RelativeLayout) convertView
					.findViewById(R.id.toggle);//(Res.getWidgetID("toggle"));
...
//			viewHolder.imageView.setLayoutParams(lp);
		...
		if (path.contains("camera_default")) {
			viewHolder.imageView.setImageResource(R.drawable.plugin_camera_no_pictures);//(Res.getDrawableID("plugin_camera_no_pictures"));
		} else {
