...
public class ReceivablesListAdapter extends BaseAdapter {
	...
	public ReceivablesListAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(subMchId!=null&&subMchId.equals("01")){
            ...
            if(maps.get("payDate")!=null){
            	String aa = maps.get("payDate").toString();
...
//            	  tv_money.setText(getWeek(aa+"00000000"));
		...
		if(maps.get("totalFee")!=null){
			...
			String a = String .format("%.2f",Double.parseDouble(maps.get("totalFee").toString()));
