...
public class CircleBar extends View {
    ...
    private float pressExtraStrokeWidth = 0;
    private BarAnimation anim;
    private int stepnumbermax  = 0;// 默认最大时间
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mColors = new int[]{0xFFFF6363, 0xFFFF3939, 0xFFFF1010};
//        mColors = new int[]{Color.rgb(0xe9, 0xe9, 0xe9),Color.RED,Color.RED};
...
//        mColorWheelPaintCentre.setAntiAlias(true);
        ...
        mDefaultWheelPaint.setColor(Color.rgb(232, 232, 232));
...
//        mColorWheelPaintCentre.setStrokeWidth(circleStrokeWidth + 5);
        mDefaultWheelPaint.setStrokeWidth(circleStrokeWidth-5);// - Textscale(2, min));
     ...
     * @param lastTag 
     */
    public void update(int stepnumber, int i, int time, TextView lastTime, TextView lastTag) {
