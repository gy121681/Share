...
//		tv_num.setText("秀儿消费总额: "+sumTotalConsumption);
		tv_num1.setText(DateUtil.Yesterday());
//		tv_sun.setText("平台消费统计: "+sumTotalConsumption);
...
//			}
			tv_num.setText("秀儿消费总额"+Util.getnum(data.total_consumption,true));
			List<ExcitationBean> bean = new ArrayList<ExcitationBean>();
