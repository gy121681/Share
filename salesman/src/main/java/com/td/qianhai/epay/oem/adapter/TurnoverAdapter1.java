...
public class TurnoverAdapter1 extends CommonAdapter<TurnoverBean> {

	public TurnoverAdapter1(Context context, List<TurnoverBean> data) {
		super(context, data, R.layout.turnover_item1);
	}
...
//		holder.setImageResource(R.id.ivPoiIcon, position==0? R.drawable.icon_82:R.drawable.icon_152);
		...
		holder.setText(R.id.tv_date, item.area_name);
		holder.setText(R.id.tv_name, item.agent_name+"  "+item.agent_phone);
