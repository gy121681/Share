...
import static com.nineoldandroids.viewem.ViewHelper.setTranslationX;
import static com.nineoldandroids.viewem.ViewPropertyAnimator.animate;
...
import com.nineoldandroids.animationem.AnimatorListenerAdapter;
...
@TargetApi(Build.VERSION_CODES.FROYO) @SuppressLint("NewApi") public class SlideTouchListener implements OnTouchListener {
