...
import com.shareshenghuo.app.user.fragment.TransferActivity2;
...
public class TransferActivity extends FragmentActivity implements
	...
	protected void init() {
		...
		btn_1.setText("产业链秀心转让");
		btn_2.setText("秀儿秀心转让");
		mPaper = (ViewPager) findViewById(R.id.view_pager);

		TextView mTvTitle = (TextView) findViewById(R.id.tvTopTitle);
		mTvTitle.setText("转让秀心");
