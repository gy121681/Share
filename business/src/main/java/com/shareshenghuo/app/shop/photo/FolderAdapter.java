...
import com.shareshenghuo.app.shop.photo.BitmapCache.ImageCallback;
...
public class FolderAdapter extends BaseAdapter {
	...
	public FolderAdapter(Context c,Activity a) {
		activity = a;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.plugin_camera_select_folder,
					 null);
			holder = new ViewHolder();
			holder.backImage = (ImageView) convertView
					.findViewById(R.id.file_back);//(Res.getWidgetID("file_back"));
			holder.imageView = (ImageView) convertView
					.findViewById(R.id.file_image);//(Res.getWidgetID("file_image"));
			holder.choose_back = (ImageView) convertView
					.findViewById(R.id.choose_back);//(Res.getWidgetID("choose_back"));
			holder.folderName = (TextView) convertView.findViewById(R.id.name);//(Res.getWidgetID("name"));
			holder.fileNum = (TextView) convertView.findViewById(R.id.filenum);//(Res.getWidgetID("filenum"));
...
//			holder.imageView.setLayoutParams(lp);
		...
		if (path.contains("android_hybrid_camera_default"))
			holder.imageView.setImageResource(R.drawable.plugin_camera_no_pictures);//(Res.getDrawableID("plugin_camera_no_pictures"));
		else {
