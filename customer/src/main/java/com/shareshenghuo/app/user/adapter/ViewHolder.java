...
public class ViewHolder {
	...
	public ViewHolder displayfi(int viewId, final String url) {
		ImageView iv = getView(viewId);
		ImageLoadManager.getInstance(mContext).displayfi(url, iv);
		return this;
	}
	
	public ViewHolder setImageByURL1(int viewId, final String url) {
		ImageView iv = getView(viewId);
		ImageLoadManager.getInstance(mContext).userphoto(url, iv);
		return this;
	}
}
