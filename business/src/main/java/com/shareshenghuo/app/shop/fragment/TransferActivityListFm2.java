...
public class TransferActivityListFm2 extends BaseFragment implements OnRefreshListener2<ListView>{
			...
			public void onSuccess(ResponseInfo<String> resp) {
				...
				if(Api.SUCCEED == bean.result_code) {
					if(bean.data.integralNew!=null){
						if(bean.data.receiveFilial!=null){
							setText(R.id.tv_num1, bean.data.receiveFilial);
						}
					}
				}
			}
